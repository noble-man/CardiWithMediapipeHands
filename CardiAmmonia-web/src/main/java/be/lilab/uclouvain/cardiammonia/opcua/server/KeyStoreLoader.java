...
class KeyStoreLoader {
    ...
    KeyStoreLoader load(File baseDir) throws Exception {
        ...
        File serverKeyStore = baseDir.toPath().resolve("cyclone-server.pfx").toFile();
        ...
        if (!serverKeyStore.exists()) {
            ...
            String applicationUri = "urn:eclipse:milo:cyclone:server:" + UUID.randomUUID();

            SelfSignedCertificateBuilder builder = new SelfSignedCertificateBuilder(keyPair)
                .setCommonName("Eclipse Milo Cyclone Server")
